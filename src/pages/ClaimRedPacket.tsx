...
declare global {
  interface Window {
    // biome-ignore lint/suspicious/noExplicitAny: <explanation> wallet
    ethereum?: any
  }
}
...
function ClaimRedPacket() {
  ...
  const loadPacketInfo = async () => {
    ...
    try {
      ...
      const contract = RedPacket__factory.connect(
      ...
      const claimedAmounts = amounts
        .slice(0, claimedCount)
        .map((amount) => ethers.formatEther(amount))
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-6">
          <div className="bg-gradient-to-r from-red-500 to-red-600 p-6 text-white text-center">
            ...
            <p className="text-red-100">
              来自 {packetInfo.creator.slice(0, 6)}...
              {packetInfo.creator.slice(-4)} 的红包
            </p>
          </div>
          ...
          <div className="p-6">
            ...
            {!isConnected ? (
              ...
              <div>
                ...
                ) : packetInfo.creator.toLowerCase() ===
                  account.toLowerCase() ? (
                  <div className="bg-gray-100 text-gray-500 py-4 rounded-lg text-center font-medium">
                    不能领取自己的红包
                  </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            ...
            <div className="space-y-2">
              {packetInfo.claimers.map((claimer, index) => (
                <div
                  // biome-ignore lint/suspicious/noArrayIndexKey: <explanation> no repeat
                  key={index}
